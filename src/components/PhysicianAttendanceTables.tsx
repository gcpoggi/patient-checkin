...
function physicianColumns(office: OfficeId, month: string): ExcelColumn<PhysicianSummary>[] {
  return [
    ...
    { key: "initialVisits", header: "Initial Visits", align: "right", filter: "none" },
    { key: "followups", header: "Follow-ups", align: "right", filter: "none" },
    { key: "ptVisits", header: "PT Therapies", align: "right", filter: "none" },
